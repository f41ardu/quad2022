...
class MPU6050{
  ...
  byte setFilterBandwidth(int config_num);
  ...
  float getAMotionROLL(){ return amotionR; };
  float getAMotionPITCH(){ return amotionP; };
  float getAMotionYAW(){ return amotionY; };

  float getMeasuresROLL(){ return measuresR; };
  float getMeasuresPITCH(){ return measuresP; };
  float getMeasuresYAW(){ return measuresY; };
  ...
  private:
    ...
    float amotionR,amotionP,amotionY;
    float measuresR, measuresP,measuresY;
